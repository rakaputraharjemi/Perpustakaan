...
public class Perpustakaan {
  public static void main(String[] args) {
    ...
    dataMahasiswa.add(new Mahasiswa("1", "Raka Putra"));
    dataMahasiswa.add(new Mahasiswa("2", "Diba Samudra"));
    dataMahasiswa.add(new Mahasiswa("3", "Akmal Geming"));

    ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("1", "Panduan Sholat"));
    dataBuku.add(new Buku("2", "Doa Doa"));
    dataBuku.add(new Buku("3", "Cara Sukses"));
      ...
      switch(menu) {
        ...
        case 1: 
          ...
          dataMahasiswa.forEach((mahasiswa) -> {
              System.out.println(mahasiswa.nama + " - " + mahasiswa.nim);
      });
          System.out.println("");
          break;
